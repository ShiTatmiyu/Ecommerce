...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="/">Genshin Impact(KW)</a>
    ...
    @else
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="/">Genshin Impact(official)</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        @endguest
	<div class="content">
		<h1 class="title">HoyoVerse</h1>
		<h3>The Most Evil Company In The World</h3>
	</div>
	<div class="container">
		<div class="products">
			<h1 id="featured">Featured Character</h1>
		...
		<a href="/shop" class="more">View More Character ></a>
	</div>
