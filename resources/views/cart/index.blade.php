...
<div class="container">
    ...
    @else
<div>
    <h3>{{$carts->count()}} Items in the Cart</h3>
</div>
    @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="top">
                    ...
                    <div class="top-right">
                        <p class="">{{number_format($cart->product->price)}}.IDR</p>
                        ...
                        <!-- Subtotal -->
                        <p class="total-item">{{number_format($cart->product->price * $cart->qty)}}.IDR</p>
                    </div>
                </div>
                <hr class="mt-2 mb-2">
                <div class="bottom">
                   <div class="row">
                        ...
                        <div class="col-lg-2">
                        <!-- delete cart -->
                        <form action="/cart/delete/{{ $cart->id }}" method="delete">
                                @csrf   
...
<div class="totalz">
    <h4 class="total-price">The total price is {{number_format($total)}}.IDR</h4>
</div>
</div>
